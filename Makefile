...
DIRS=$(SRCDIR) $(SRCDIR)/buffer $(SRCDIR)/compare $(SRCDIR)/hash \
     ...
     $(SRCDIR)/digital_signature/ref $(SRCDIR)/mac $(SRCDIR)/prng \
     $(SRCDIR)/prng/unix $(SRCDIR)/prng/windows $(SRCDIR)/suite
...
TESTDIRS=$(TESTDIR) $(TESTDIR)/buffer $(TESTDIR)/hash \
         $(TESTDIR)/digital_signature $(TESTDIR)/mac $(TESTDIR)/prng \
         $(TESTDIR)/suite
