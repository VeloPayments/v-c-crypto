 ...
 */
TEST(vccrypt_buffer_init_for_base64_serialization, simpletest)
{
    ...
    EXPECT_EQ(BASE64_BUFFER_SIZE, buffer.size);
 ...
 */
TEST(vccrypt_buffer_init_for_base64_serialization, paddingTest)
{
    ...
    ASSERT_EQ(
        ...
        vccrypt_buffer_init_for_base64_serialization(
            &buffer, &alloc_opts, 4));
    EXPECT_EQ((size_t)8, buffer.size);
    ...
    ASSERT_EQ(
        ...
        vccrypt_buffer_init_for_base64_serialization(
            &buffer, &alloc_opts, 7));
    EXPECT_EQ((size_t)12, buffer.size);
 ...
 */
TEST(vccrypt_buffer_init_for_base64_serialization, allocation_failure)
{
    const size_t BUFFER_SIZE = 4;
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
