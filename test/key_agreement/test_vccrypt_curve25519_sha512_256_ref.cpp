...
class vccrypt_curve25519_sha512_256_ref_test : public ::testing::Test {
protected:
    void SetUp() override
    {
 ...
 */
TEST_F(vccrypt_curve25519_sha512_256_ref_test, prng_options_init)
{
 ...
 */
TEST_F(vccrypt_curve25519_sha512_256_ref_test, options_init)
{
 ...
 */
TEST_F(vccrypt_curve25519_sha512_256_ref_test, init)
{
    vccrypt_key_agreement_options_t options;
 ...
 */
TEST_F(vccrypt_curve25519_sha512_256_ref_test, alice_bob)
{
 ...
 */
TEST_F(vccrypt_curve25519_sha512_256_ref_test, alice_bob_short_term)
{
    const uint8_t ALICE_PRIVATE[] = {
        0x77, 0x07, 0x6d, 0x0a, 0x73, 0x18, 0xa5, 0x7d,
        0x3c, 0x16, 0xc1, 0x72, 0x51, 0xb2, 0x66, 0x45,
 ...
 */
TEST_F(vccrypt_curve25519_sha512_256_ref_test, random)
{
    vccrypt_key_agreement_options_t options;
    vccrypt_key_agreement_context_t context;
