 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, init_default)
{
 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, init_mocked)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, dispose_mocked)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
    ...
    EXPECT_EQ(&suite.key_auth_opts, got_options);
 ...
 * VCCRYPT_ERROR_MOCK_NOT_ADDED.
 */
TEST(vccrypt_mock_auth_key_agreement_functions, long_term_secret_default)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, long_term_secret_mocked)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
 ...
 * VCCRYPT_ERROR_MOCK_NOT_ADDED.
 */
TEST(vccrypt_mock_auth_key_agreement_functions, short_term_secret_default)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, short_term_secret_mocked)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, keypair_create_default)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
 ...
 */
TEST(vccrypt_mock_auth_key_agreement_functions, keypair_create_mocked)
{
    vccrypt_suite_options_t suite;
    allocator_options_t alloc_opts;
    vccrypt_key_agreement_context_t agreement;
