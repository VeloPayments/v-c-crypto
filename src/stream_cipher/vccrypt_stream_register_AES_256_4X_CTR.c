...
void vccrypt_stream_register_AES_256_4X_CTR()
{
    ...
    aes_4x_options.hdr.dispose = &vccrypt_aes_ctr_alg_options_dispose;
    ...
    aes_4x_options.vccrypt_stream_alg_dispose = &vccrypt_aes_ctr_alg_dispose;
    aes_4x_options.vccrypt_stream_alg_start_encryption =
        &vccrypt_aes_ctr_alg_start_encryption;
    aes_4x_options.vccrypt_stream_alg_continue_encryption =
    ...
    aes_4x_options.vccrypt_stream_alg_continue_decryption =
    ...
    aes_4x_options.vccrypt_stream_alg_options_init =
