/**
 * \file vccrypt_mock_suite_add_mock_digital_signature_verify.cpp
 *
 * Mock the digital signature algorithm verify method.
 *
            ...
            const vccrypt_buffer_t*, const uint8_t*, size_t)> func)
{
    ...
    mock->digital_signature_verify_mock.reset(new (decltype (func))(func));
