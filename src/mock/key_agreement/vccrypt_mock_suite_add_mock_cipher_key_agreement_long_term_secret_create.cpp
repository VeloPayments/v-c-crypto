/**
 * \file
 * vccrypt_mock_suite_add_mock_cipher_key_agreement_long_term_secret_create.cpp
 *
 * Mock the key agreement algorithm long-term secret create method.
 *
            ...
            const vccrypt_buffer_t*, vccrypt_buffer_t*)> func)
{
    ...
    mock->key_agreement_long_term_secret_create_mock.reset(
