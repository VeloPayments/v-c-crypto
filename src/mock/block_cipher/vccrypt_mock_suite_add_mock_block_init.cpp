/**
 * \file src/mock/block_cipher/vccrypt_mock_suite_add_mock_block_init.cpp
 *
 * Mock the block cipher algorithm init method.
 *
            ...
            vccrypt_buffer_t*, bool)> func)
{
    ...
    mock->block_init_mock.reset(new (decltype (func))(func));
