 ...
 */
static int velo_mock_prng_init(
    void* UNUSED(options), vccrypt_prng_context_t* UNUSED(context))
{
    /* TODO - fill out. */
 ...
 */
static int velo_mock_mac_init(
    void* UNUSED(options), vccrypt_mac_context_t* UNUSED(context),
 ...
 */
static int velo_mock_block_cipher_init(
    void* UNUSED(options), vccrypt_block_context_t* UNUSED(context),
    vccrypt_buffer_t* UNUSED(key), bool UNUSED(encrypt))
{
    /* TODO - fill out. */
