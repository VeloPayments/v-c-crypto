/**
 * \file vccrypt_key_agreement_short_term_secret_create_common.c
 *
 * \brief Shared function for creating the short-term secret between two peers
 * using the private key from one, the public key from the other, and nonce
 * values from both.
 *
