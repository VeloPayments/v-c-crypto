...
void vccrypt_key_agreement_register_curve25519_sha512()
{
    ...
    curve25519_sha512_options.shared_secret_size = 64;
    curve25519_sha512_options.private_key_size = 32;
    curve25519_sha512_options.public_key_size = 32;
    curve25519_sha512_options.minimum_nonce_size = 64;
