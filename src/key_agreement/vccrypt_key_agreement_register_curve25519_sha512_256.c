...
static int vccrypt_curve25519_sha512_256_options_init(
    void* options, allocator_options_t* alloc_opts);
static void vccrypt_curve25519_sha512_256_options_dispose(void* disp);
...
static int vccrypt_curve25519_sha512_256_short_term_secret_create(
    void* context, const vccrypt_buffer_t* priv,
...
void vccrypt_key_agreement_register_curve25519_sha512_256()
{
    ...
    curve25519_sha512_256_options.hdr.dispose =
        &vccrypt_curve25519_sha512_256_options_dispose;
    ...
    curve25519_sha512_256_options.vccrypt_key_agreement_alg_short_term_secret_create =
        &vccrypt_curve25519_sha512_256_short_term_secret_create;
    curve25519_sha512_256_options.vccrypt_key_agreement_alg_keypair_create =
        &vccrypt_curve25519_sha512_256_keypair_create;
    curve25519_sha512_256_options.vccrypt_key_agreement_alg_options_init =
        &vccrypt_curve25519_sha512_256_options_init;
